...
namespace IANodeGraph
{
    ...
    public class NodeValueAttribute : Attribute
    {
        ...
        public NodeValueAttribute(string lable, bool showDrawer = false, PortDirection direction = PortDirection.Left, PortCapacity capacity = PortCapacity.Single, string tooltip = "")
        {
            Lable = lable;
