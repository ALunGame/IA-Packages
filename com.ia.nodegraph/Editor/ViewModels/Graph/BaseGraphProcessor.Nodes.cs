...
namespace IANodeGraph.Model
{
    public partial class BaseGraphProcessor
    {
        ...
        public BaseNodeProcessor AddNode<T>(Vector2Int position) where T : BaseNode, new()
        {
            return AddNode(TypeCache<T>.TYPE, position);
        }

        public BaseNodeProcessor AddNode(Type nodeType, Vector2Int position)
        {
        ...
        public virtual BaseNodeProcessor NewNode(Type nodeType, Vector2Int position)
        {
        ...
        public virtual BaseNodeProcessor NewNode<TNode>(Vector2Int position) where TNode : BaseNode, new()
        {
            var node = new TNode()
            {
                id = NewID(),
